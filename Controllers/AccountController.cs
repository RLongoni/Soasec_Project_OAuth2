...
namespace Soasec_Oauth2_Project.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        // [ValidateAntiForgeryToken]
        public async Task<ActionResult> AuthorizeLogin(LoginViewModel model, string returnUrl)
        {
            using (HttpClient client = new HttpClient())
            {
                ...
                options.ExpiresUtc = DateTime.UtcNow.AddMinutes(token.ExpiresInSeconds);

                var claims = new[]
                {
                    new Claim(ClaimTypes.Name, model.Email),
                    new Claim(ClaimTypes.NameIdentifier, token.AccessToken),
                };
        ...
        public ActionResult LogOff()
        {
            ...
            myConfiguration.AppSettings.Settings.Remove("Bearer_Twitter_Token");
